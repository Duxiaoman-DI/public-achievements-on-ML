...
我们研发的AutoML创新性地提出[高性能的集成贝叶斯优化策略](# Higher Performance for AutoML: The Benefit of Various Ensemble Bayesian Optimization Strategy )，通过对多个代理模型进行结果优化，在更早的迭代周期内就能找到全局最优解。相关成果获得NIPS 2020黑盒优化竞赛第四名（https://bbochallenge.com/leaderboard/）。    

## <a name='Higher Performance for AutoML: The Benefit of Various Ensemble Bayesian Optimization Strategy'></a>
